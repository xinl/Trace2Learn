...
//	            	   NewTagDialogFragment.this;
	            	   EditText tagEditText = (EditText) NewTagDialogFragment.this.getDialog().findViewById(R.id.tag_text);
	            	   String tag = tagEditText.getText().toString();
	            	   mListener.onNewTagDialogPositiveClick(tag);
	               }
	           })
